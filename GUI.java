...
// Bremsen Spieler 2
 ...
 // Auslesen der Koordinataten wo das Auto gerade steht
    ...
    int yCoord = this.jLabelAutoSpieler2.getLocation().y;
      // Bremsen zieht Geschwindigkeit ab  
...
// Geschwindigkeit wird addiert
                ...
                this.tankSpieler2 = (int) (this.tankSpieler2 - this.speedSpieler2/tankFaktor);
                yCoord = yCoord - this.speedSpieler2;
            }
        }
...
// Wenn Koordinate 0 erreicht Meldung das Gewonnen wurde
        ...
        if (tankSpieler2 <= 0){
            this.nextStepSpieler2 = "TANK LEER!";
                    this.speedSpieler2 = 0;
   ...
   // Auslesen der Koordinataten wo das Auto gerade steht 
   int xCoord = this.jLabelAutoSpieler1.getLocation().x;
   int yCoord = this.jLabelAutoSpieler1.getLocation().y;
      ...
      if (!this.nextStepSpieler1.equals("")) {
            if (this.nextStepSpieler1.equals("bremsen")) {
                if (this.speedSpieler1 - 3 >= 0){
                    ...
                    yCoord = yCoord - this.speedSpieler1;
                } else {
...
// Geschwindigkeit wird addiert
                ...
                this.speedSpieler1 = this.speedSpieler1 + 3;
                this.tankSpieler1 = (int) (this.tankSpieler1 - this.speedSpieler1/tankFaktor);
                yCoord = yCoord - this.speedSpieler1;
            }
        }
...
// Wenn Koordinate 0 erreicht Meldung das Gewonnen wurde
        ...
        // Wenn Tank 0 ist Meldung das Tank leer ist
        if (tankSpieler1 <= 0){
            this.nextStepSpieler1 = "TANK LEER!";
                    this.speedSpieler1 = 0;
                    
        }
        // Setzen der Ausgabefelder im Spiel
        this.jLabelAutoSpieler1.setLocation(xCoord, yCoord);
